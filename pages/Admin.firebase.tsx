...
const SubscribersView = ({ subscribers, loading }: any) => (
  <div className="bg-[#1a1f35]/60 rounded-2xl border border-white/10 overflow-hidden">
    <div className="p-6 border-b border-white/10 flex justify-between items-center">
      <div>
        <h3 className="font-bold text-lg text-white">Lista de Suscriptores</h3>
        <p className="text-sm text-gray-400 mt-1">Total: {subscribers.length} suscriptores</p>
      </div>
    </div>
    ...
    {loading ? (
      ...
      <EmptyState title="No hay suscriptores" description="Los emails aparecerán aquí" />
    )}
  </div>
);
  ...
  return (
    <div className="min-h-screen bg-[#0a0f1e] text-white">
      ...
      <main className="ml-64 p-8">
       ...
       {currentView === 'subscribers' && <SubscribersView subscribers={subscribers} loading={loadingSubscribers} />}
      </main>
